...
namespace obras_mvc_ef.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public ArtistasController(GaleriaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Pais")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nombre,Pais")] Artista artista)
        {
            if (id != artista.Id)
            {
                return NotFound();
